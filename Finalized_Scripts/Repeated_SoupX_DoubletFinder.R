...
for(i in 1:4){
  ...
  sc  <- autoEstCont(sc)
  out <- adjustCounts(sc,roundToInt = TRUE) #This must be true for downstream DESeq2 workflows to work 
...
Idents(All_Groups_log_Decontaminated) <- factor(x = Idents(All_Groups_log_Decontaminated),
                                                levels = c("Drd1-MSN",
                                                           "Drd2-MSN",
                                                           "Drd2-MSN-2",
                                                           "Drd3-MSN",
...
All_Groups_log_Decontaminated$CellType <- Idents(All_Groups_log_Decontaminated)
...
#   [1] ROCR_1.0-11         KernSmooth_2.23-17  fields_11.6         spam_2.5-1         
# [5] dotCall64_1.0-0     dplyr_1.0.2         DoubletFinder_2.0.3 ggplot2_3.3.2      
# [9] SoupX_1.5.2         SeuratObject_4.0.2  Seurat_4.0.4       
# 
# loaded via a namespace (and not attached):
#   [1] Rtsne_0.15                  colorspace_1.4-1            deldir_1.0-6               
# [4] ellipsis_0.3.2              ggridges_0.5.2              XVector_0.28.0             
# [7] GenomicRanges_1.40.0        rstudioapi_0.11             spatstat.data_2.1-0        
# [10] leiden_0.3.3                listenv_0.8.0               farver_2.0.3               
# [13] ggrepel_0.8.2               RSpectra_0.16-0             codetools_0.2-16           
# [16] splines_4.0.2               polyclip_1.10-0             jsonlite_1.7.1             
# [19] Rsamtools_2.4.0             ica_1.0-2                   cluster_2.1.0              
...
# [31] lazyeval_0.2.2              limma_3.44.3                cli_3.3.0                  
# [34] later_1.1.0.1               htmltools_0.5.2             tools_4.0.2                
# [37] igraph_1.2.6                GenomeInfoDbData_1.2.3      gtable_0.3.0               
# [40] glue_1.6.2                  RANN_2.6.1                  reshape2_1.4.4             
# [43] maps_3.3.0                  rappdirs_0.3.1              Rcpp_1.0.7                 
# [46] Biobase_2.48.0              scattermore_0.7             Biostrings_2.56.0          
# [49] vctrs_0.4.1                 nlme_3.1-149                rtracklayer_1.48.0         
# [52] lmtest_0.9-38               stringr_1.4.0               globals_0.13.1             
# [55] mime_0.9                    miniUI_0.1.1.1              lifecycle_0.2.0            
# [58] irlba_2.3.3                 XML_3.99-0.5                goftest_1.2-2              
# [61] future_1.19.1               MASS_7.3-53                 zlibbioc_1.34.0            
# [64] zoo_1.8-8                   scales_1.1.1                spatstat.core_2.3-0        
# [67] promises_1.1.1              spatstat.utils_2.2-0        SummarizedExperiment_1.18.2
# [70] parallel_4.0.2              RColorBrewer_1.1-2          yaml_2.2.1                 
# [73] reticulate_1.16             pbapply_1.4-3               gridExtra_2.3              
# [76] rpart_4.1-15                stringi_1.7.6               S4Vectors_0.26.1           
# [79] BiocGenerics_0.34.0         BiocParallel_1.22.0         GenomeInfoDb_1.24.2        
# [82] rlang_1.0.2                 pkgconfig_2.0.3             matrixStats_0.57.0         
# [85] bitops_1.0-6                lattice_0.20-41             purrr_0.3.4                
# [88] tensor_1.5                  GenomicAlignments_1.24.0    patchwork_1.0.1            
# [91] htmlwidgets_1.5.2           labeling_0.3                cowplot_1.1.0              
# [94] tidyselect_1.1.0            RcppAnnoy_0.0.19            plyr_1.8.6                 
# [97] magrittr_1.5                R6_2.4.1                    IRanges_2.22.2             
# [100] generics_0.0.2              DelayedArray_0.14.1         pillar_1.4.6               
# [103] withr_2.3.0                 mgcv_1.8-33                 fitdistrplus_1.1-1         
# [106] survival_3.2-7              abind_1.4-5                 RCurl_1.98-1.2             
# [109] tibble_3.0.4                future.apply_1.6.0          crayon_1.3.4               
# [112] spatstat.geom_2.4-0         plotly_4.9.2.1              data.table_1.13.0          
# [115] digest_0.6.26               xtable_1.8-4                tidyr_1.1.2                
# [118] httpuv_1.5.4                stats4_4.0.2                munsell_0.5.0              
