...
NAc_Combo$sample.id <- factor(NAc_Combo$sample.id)
sample_ids <- purrr::set_names(levels(NAc_Combo$sample.id))
sample_ids
# Acute_Fem_Coc       Acute_Fem_Sal      Acute_Male_Coc      Acute_Male_Sal    Repeated_Fem_Coc    Repeated_Fem_Sal   Repeated_Male_Coc   Repeated_Male_Sal 
# "Acute_Fem_Coc"     "Acute_Fem_Sal"    "Acute_Male_Coc"    "Acute_Male_Sal"  "Repeated_Fem_Coc"  "Repeated_Fem_Sal" "Repeated_Male_Coc" "Repeated_Male_Sal" 
...
table(NAc_Combo@meta.data$sample.id)
# Acute_Fem_Coc     Acute_Fem_Sal    Acute_Male_Coc    Acute_Male_Sal  Repeated_Fem_Coc  Repeated_Fem_Sal Repeated_Male_Coc Repeated_Male_Sal 
# 4895              3671              3184              3905              6537              5736              5737              5589 
