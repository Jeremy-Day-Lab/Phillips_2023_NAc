...
dim(count_aggr)
#[1]    16 30560
#16 individual samples from 2 clusters and 8 individual GEM wells
...
ggsave(plot = cowplot::plot_grid(plotlist = list(pca.plot.CellType,
                                                 ...
                                                 pca.plot.sex_stim),
                                 ncol = 3),
       filename = "2019-JD-0040/MCN_Code/Plots/DESeq2_D1s/PCA_Plots_Combo.pdf",
       height = 8,
       width = 16)
...
write.table(x         = res_df,
            file      = "2019-JD-0040/MCN_Code/Tables/DESeq2_D1s/Drd1_DESeq2_results.txt",
            sep       = "\t",
            col.names = TRUE,
            row.names = FALSE,
            quote     = FALSE)
...
write.table(x         = subset(res_df,subset=(padj <= 0.05 & log2FoldChange < (-0.5))),
            file      = "2019-JD-0040/MCN_Code/Tables/DESeq2_D1s/Drd1_DESeq2_Down.txt",
            sep       = "\t",
            col.names = TRUE,
            row.names = FALSE,
            quote     = FALSE)
...
write.table(x         = subset(res_df,subset=(padj <= 0.05 & log2FoldChange > 0.5)),
            file      = "2019-JD-0040/MCN_Code/Tables/DESeq2_D1s/Drd1_DESeq2_Up.txt",
            sep       = "\t",
            col.names = TRUE,
            row.names = FALSE,
            quote     = FALSE)
...
#   [1] ggrepel_0.8.2               pheatmap_1.0.12             RColorBrewer_1.1-2          DESeq2_1.28.1               SummarizedExperiment_1.18.2 DelayedArray_0.14.1         matrixStats_0.57.0         
# [8] Biobase_2.48.0              GenomicRanges_1.40.0        GenomeInfoDb_1.24.2         IRanges_2.22.2              S4Vectors_0.26.1            BiocGenerics_0.34.0         Matrix.utils_0.9.8         
# [15] Matrix_1.3-4                ComplexUpset_1.3.3          stringr_1.4.0               dplyr_1.0.2                 Libra_1.0.0                 ggplot2_3.3.2               SeuratObject_4.0.2         
# [22] Seurat_4.0.4               
# 
...
# [25] rappdirs_0.3.1         crayon_1.3.4           RCurl_1.98-1.2         jsonlite_1.7.1         genefilter_1.70.0      lme4_1.1-26            spatstat.data_2.1-0    survival_3.2-7        
# [33] zoo_1.8-8              glue_1.6.2             polyclip_1.10-0        gtable_0.3.0           zlibbioc_1.34.0        XVector_0.28.0         leiden_0.3.3           future.apply_1.6.0    
# [41] abind_1.4-5            scales_1.1.1           DBI_1.1.0              edgeR_3.30.3           miniUI_0.1.1.1         Rcpp_1.0.7             viridisLite_0.3.0      xtable_1.8-4          
# [49] reticulate_1.16        spatstat.core_2.3-0    bit_4.0.4              htmlwidgets_1.5.2      httr_1.4.2             ellipsis_0.3.2         ica_1.0-2              farver_2.0.3          
# [57] pkgconfig_2.0.3        XML_3.99-0.5           uwot_0.1.10            deldir_1.0-6           locfit_1.5-9.4         labeling_0.3           tidyselect_1.1.0       rlang_1.0.2           
# [65] reshape2_1.4.4         later_1.1.0.1          AnnotationDbi_1.50.3   pbmcapply_1.5.0        munsell_0.5.0          tools_4.0.2            cli_3.3.0              generics_0.0.2        
# [73] RSQLite_2.2.1          ggridges_0.5.2         fastmap_1.1.0          yaml_2.2.1             goftest_1.2-2          bit64_4.0.5            fitdistrplus_1.1-1     purrr_0.3.4           
# [81] RANN_2.6.1             pbapply_1.4-3          future_1.19.1          nlme_3.1-149           mime_0.9               grr_0.9.5              compiler_4.0.2         rstudioapi_0.11       
# [89] plotly_4.9.2.1         png_0.1-7              spatstat.utils_2.2-0   tibble_3.0.4           statmod_1.4.35         geneplotter_1.66.0     stringi_1.7.6          forcats_0.5.0         
# [97] lattice_0.20-41        nloptr_1.2.2.2         vctrs_0.4.1            pillar_1.4.6           lifecycle_0.2.0        spatstat.geom_2.4-0    lmtest_0.9-38          RcppAnnoy_0.0.19      
# [105] data.table_1.13.0      cowplot_1.1.0          bitops_1.0-6           irlba_2.3.3            httpuv_1.5.4           patchwork_1.0.1        R6_2.4.1               promises_1.1.1        
# [113] KernSmooth_2.23-17     gridExtra_2.3          codetools_0.2-16       boot_1.3-25            MASS_7.3-53            withr_2.3.0            sctransform_0.3.2      GenomeInfoDbData_1.2.3
# [121] mgcv_1.8-33            grid_4.0.2             rpart_4.1-15           glmmTMB_1.1.3          tidyr_1.1.2            minqa_1.2.4            Rtsne_0.15             numDeriv_2016.8-1.1   
# [129] shiny_1.5.0   
# 
# 
# 
